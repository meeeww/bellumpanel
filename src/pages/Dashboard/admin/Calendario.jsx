            ...
            <div className="dashboardAdmin">
                ...
                <div className="flex navbarContainer">
                    ...
                    <div className="w-full">
                        <div class="flex items-center justify-center py-8 px-4 calendario">
                            <div class=" w-full shadow-lg">
                                <div class="md:p-8 p-5 dark:bg-gray-800 bg-[var(--color-principal-dashboard)] rounded-t">
                                ...
                                <div class="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-[var(--color-principal-dashboard)] rounded-b">
                                    <div class="px-4">
